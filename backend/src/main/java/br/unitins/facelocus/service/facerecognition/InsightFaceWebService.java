...
public class InsightFaceWebService implements FaceRecognitionService {
    ...
    String INSIGHT_FACE_SERVICE_URL;

    @Override
    @SneakyThrows
    public boolean faceDetected(String photoFacePath, String profilePhotoFacePath) {
        HttpClient client = HttpClient.newHttpClient();
        String url = String.format("%s?photoFacePath=%s&profilePhotoFacePath=%s", INSIGHT_FACE_SERVICE_URL, photoFacePath, profilePhotoFacePath);
        ...
        try {
            ...
            throw new RuntimeException("Falha ao acessar serviço de reconhecimento facial InsightFace");
        }
